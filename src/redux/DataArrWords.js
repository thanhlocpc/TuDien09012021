const defaultArrWords = [
    ...
    { id: 4, en: 'active', vn: 'chủ động', memorized: true, isShow: true },
    ...
    { id: 8, en: 'yesterday', vn: 'hôm qua', memorized: true, isShow: true },
    { id: 9, en: 'young', vn: 'trẻ', memorized: true, isShow: true },
    ...
    { id: 13, en: 'against', vn: 'phản đối', memorized: true, isShow: true },
    { id: 14, en: 'arrange', vn: 'sắp xếp', memorized: false, isShow: false }
];

export default defaultArrWords;
